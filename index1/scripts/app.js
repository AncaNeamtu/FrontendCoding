...
function showList() {
    var myTable = '<table border="1" class="table-hover"><tr><th>First Name</th><th>Last Name</th><th>Phone</th><th>Salary</th></tr>';
...
function salaryTotal(){
    ...
    var paragraf= '<p>Salary Total:'+total+' </p>';
    var container = document.getElementById('listcontainer2');
    container.innerHTML = paragraf;
}
function Delete(){
    var firstName = document.getElementById("firstName").value;
    var lastName = document.getElementById("lastName").value;
